organization_tool = {
    ...
    init_data: function () {
        ...
        $.ajax({
            method: 'get',
            url: common_tool.getRootPath() + '/organization/select',
            async: false,
            dataType: 'json',
    ...
    delete: function (id) {
        $.ajax({
            ...
            method: 'get',
            url: common_tool.getRootPath() + '/organization/delete',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    save: function () {
        ...
        $.ajax({
            ...
            method: 'post',
            url: common_tool.getRootPath() + '/organization/insert',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    update: function () {
        ...
        $.ajax({
            ...
            method: 'post',
            url: common_tool.getRootPath() + '/organization/update',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
