job_tool = {
    ...
    save: function () {
        ...
        $.ajax({
            ...
            method: 'post',
            url: common_tool.getRootPath() + '/job/insert',
            async: false,
            dataType: 'json',
    ...
    update: function () {
        ...
        $.ajax({
            ...
            method: 'post',
            url: common_tool.getRootPath() + '/job/update',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    delete: function (id) {
        $.ajax({
            ...
            method: 'get',
            url: common_tool.getRootPath() + '/job/delete',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    init_main_view: function () {
        $("#job_grid").treegrid({
            url: common_tool.getRootPath() + '/job/select',
            method: 'get',
            idField: "id",
            nodeId: 'id',
            treeField: 'name',
