data_tool = {
    ...
    delete_data: function () {
        if ($("#data_grid").treegrid("getChecked").length == 0) {
            ...
            $.ajax({
                ...
                method: 'get',
                url: common_tool.getRootPath() + '/system/data/delete',
                async: false,
                dataType: 'json',
    ...
    save_data: function () {
        ...
        $.ajax({
            ...
            method: 'post',
            url: common_tool.getRootPath() + '/system/data/insert',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    update_data: function () {
        ...
        $.ajax({
            ...
            method: 'post',
            url: common_tool.getRootPath() + '/system/data/update',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    insert_data_group: function () {
        if (!$("#save-data-group-dialog input[id='data_group_name']").validatebox('isValid')) {
            ...
            $.ajax({
                ...
                method: 'post',
                url: common_tool.getRootPath() + '/system/dataGroup/insert',
                async: false,
                dataType: 'json',
                success: function (result) {
                    if (result.code == 10000) {
