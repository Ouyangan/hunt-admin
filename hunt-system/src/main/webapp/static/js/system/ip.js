ip_tool = {
    init_main_view: function () {
        $.ajax({
            data: {},
            method: 'get',
            url: common_tool.getRootPath() + '/system/ip/intercept/status',
            async: false,
            dataType: 'json',
    ...
    save: function () {
        if (!$("#ip-name").validatebox('isValid')) {
            ...
            $.ajax({
                ...
                traditional: true,
                method: 'post',
                url: common_tool.getRootPath() + '/system/ip/insert',
                async: false,
                dataType: 'json',
                success: function (result) {
                    if (result.code == 10000) {
    ...
    update: function () {
        if (!$("#ip-name").validatebox('isValid')) {
            ...
            $.ajax({
                ...
                traditional: true,
                method: 'post',
                url: common_tool.getRootPath() + '/system/ip/update',
                async: false,
                dataType: 'json',
                success: function (result) {
                    if (result.code == 10000) {
    ...
    delete: function (id) {
        $.ajax({
            ...
            traditional: true,
            method: 'get',
            url: common_tool.getRootPath() + '/system/ip/delete',
            async: false,
            dataType: 'json',
            success: function (result) {
                if (result.code == 10000) {
    ...
    $('#ip-switchButton-btn').switchbutton({
        ...
        onChange: function (checked) {
            ...
            $.ajax({
                ...
                method: 'get',
                url: common_tool.getRootPath() + '/system/ip/intercept',
                async: false,
                dataType: 'json',
                success: function (result) {
                    if (result.code == 10000) {
